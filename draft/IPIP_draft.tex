...
\hypertarget{correlations-and-regressions.}{%
\paragraph{Correlations and
regressions.}\label{correlations-and-regressions.}}
...
\subsubsection{Sample and procedure.}\label{sample-and-procedure.}}
...
\hypertarget{study-1-construction-with-an-us-american-sample-1}{%
\subsection{Study 1 -- Construction with an US-American
sample}\label{study-1-construction-with-an-us-american-sample-1}}
...
domain as well as Eigenvalues and results from MAP and PA test. To
...
found in Table 2. The exploratory structural equation model (ESEM) of
the final model with all five domains fits well with CFI = .87, RMSEA =
.072, SRMR = .036. As you can see in Table 3 nearly all facets load
significantly on their intended domain, but sometimes have loadings on
other domains also, which are conform with the theory and the facet
content.
