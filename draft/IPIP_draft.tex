...
facets covered by the different instruments. ({\textbf{???}}) inspected
the convergences between the NEO-PI-R and the first version of the BFI,
suggesting that two constructs per domain were measured at the facet
level by both inventories. The constructs defined by ({\textbf{???}})
were: Assertiveness and Activity for Extraversion; Altruism and
...
you can see in Table 4 nearly all facets load significantly on their
