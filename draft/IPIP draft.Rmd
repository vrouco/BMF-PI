...
As can be seen in the table, there is no consensus at the facet level between the different Big Five questionnaires (look for overlaps & few words about the table?)
