...
< Table 3 caption="Model fit for each facet")>
...
< Table 4 caption="ESEM factor scores")> 
...
print(xtable(mytable, caption="ESEM factor scores"),include.rownames=FALSE, size="\\fontsize{9.5pt}{9pt}\\selectfont", caption.placement = "top",sanitize.text.function=Hmisc::latexTranslate)
```
...
< Table 5 caption="Criterion correlations" >
