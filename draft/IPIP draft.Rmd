...
```{r table3 model fits CFA, warning=F}
setwd(here())
...
```{r table 4 esem1, results="asis", message=F}
setwd(here())
...
We have come out to a open access instrument which is valid in two different cultures and maximizes the number of facets measured. 
